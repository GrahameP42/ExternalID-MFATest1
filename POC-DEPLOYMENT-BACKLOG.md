...
| POC-015 | Validation | Smoke test: Sign in with passkey (Windows Hello or FIDO2) | P0 | In Progress | 2026-08-12 |  | POC-014 | 🔴 ROOT CAUSE IDENTIFIED & FIXED: AADSTS9002326 — App registration was missing Static Web Apps URI from SPA redirect URIs. App only had local dev URL (auth.petchyentraexternalidtest03.ciamlogin.com:3000). Fix: Added https://orange-coast-0407c830f.7.azurestaticapps.net/ to SPA configuration. Retry login in regular (non-InPrivate) browser to validate fix. |
