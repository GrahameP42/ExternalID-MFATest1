...
async function createCredential(creationOptions) {
    ...
    const publicKey = {
        ...
        rp: {
            // Graph returns mixed-case rp.id (e.g. "PetchyEntraExternalIDTest03.ciamlogin.com").
            // Browser rp.id validation is case-sensitive against the lowercase serving domain,
            // so normalise to lowercase unconditionally.
            id: (appConfig.customDomain || creationOptions.rp.id).toLowerCase(),
